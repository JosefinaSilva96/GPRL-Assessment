...
*------------------------------------------------------------------------------- 		
   ...
   * Directory
	...
	cd "C:\Users\wb631166\OneDrive - WBG\Desktop\Taxes\G2Px\Deliverable_Jan132025" // change directory 

	*cd: "https://worldbankgroup-my.sharepoint.com/shared?id=%2Fpersonal%2Frfloresibarra%5Fworldbank%5Forg%2FDocuments%2FPersonalized%20VAT%20project%20%2DRS%20Brazil%2FSurvey%2FStata&listurl=%2Fpersonal%2Frfloresibarra%5Fworldbank%5Forg%2FDocuments"
	
	
	*Load data set 
	
	use "C:\Users\wb631166\OneDrive - WBG\Desktop\Taxes\G2Px\Deliverable_Jan132025\devolve_survey_jan.dta", replace // 1,039 obs and 236 variables 
...
*------------------------------------------------------------------------------- 		
   ...
   * Type of phone 
	...
	*How much is the ICMS charged on most of the things we buy in Rio Grande do Sul?
	...
	la de lblicms_rate2 1 "Less 50%" 2 "between 5-10%" 3 "between 10-20%" 4 "between 20-30%"  5 "between 30-40%" 6 "more than 40%" 666 "Don't know"
	
	label values icms_rate2 lblicms_rate2
...
*-------------------------------------------------------------------------------  
   ...
   keep data id_entrevista estrato phone_type age_over18 hh know_devolve participates_devolve program_discovery knows_participant other_beneficiaries_family other_beneficiaries_friends other_beneficiaries_leaders other_beneficiaries_other other_beneficiaries_dontknow reason_money_accounts program_eligilibility deposit_frequency quarterly_deposit usage_increases unused_funds payment_method_cash payment_method_debit payment_method_credit payment_method_pix payment_method_mobile payment_method_other payment_method_daily purchases_last_week hh_bank_account bank_account_brasil bank_account_bradesco bank_account_itau bank_account_santander bank_account_nubank bank_account_inter bank_account_c6 bank_account_banrisul bank_account_pagbank bank_account_picpay bank_account_agibank bank_account_sicredi bank_account_caixa bank_account_other bank_account_dontknow store_receipt reason_no_receipt consumption_receipt type_cpf freq_cpf cpf_invoice_freq reason_not_cpf_time reason_not_cpf_number reason_not_cpf_interest reason_not_cpf_benefits reason_not_cpf_inofrmation reason_not_cpf_other freq_cpf_na reason_not_cpf_time_da reason_not_cpf_number_da reason_not_cpf_interest_dat reason_not_cpf_benefits_da reason_not_cpf_inofrmation_da reason_not_cpf_other_da monthly_spend card_devolve cpf_receipt_freq spend_value use_citizen_card main_use_card problem_card problem_card_na problem_card_transfer problem_card_money problem_card_password problem_card_other problem_card_dk get_card card_collection_l card_collection_d card_collection_k card_collection_w card_collection_t card_collection_p card_collection_dp card_collection_other card_collection_dk stores_nearby card_use_worry worry_unauthorized_card inequality_brazil tax_collection tax_revenue_preference tax_essential_goods icms_rate_rgs cpf_on_invoice_rule increase_tax_on_food tax_on_foodreturned tax_food_all tax_perfumes_makeup nota_fiscal_program participate_nfg reason_nfg send_information send_information_method municipality age gender income household_size flood_impact flood_impact2 displaced_rains displaced_rains_days flood_aid aid_finance aid_material aid_medic aid_cleaning aid_reconstruction aid_other aid_dk unit day month year
